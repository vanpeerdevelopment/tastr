package be.vdab.vrijstellingenbeleid.service.architecture;

import be.vdab.vrijstellingenbeleid.infrastructure.messaging.EventHandler;
import be.vdab.vrijstellingenbeleid.infrastructure.messaging.Handle;
...
public class EventHandlerMethodsHebbenHandleAnnotatieTest extends UnitTest {
    ...
    private Set<BeanDefinition> eventHandlers() {
        ...
        return scanner.findCandidateComponents("be.vdab.vrijstellingenbeleid.service");
    }
