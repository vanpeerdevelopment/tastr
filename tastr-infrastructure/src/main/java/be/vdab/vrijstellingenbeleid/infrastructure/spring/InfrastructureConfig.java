...
public class InfrastructureConfig {
    ...
    public static final String INFRASTRUCTURE_BASE_PACKAGE = "be.vdab.vrijstellingenbeleid.infrastructure";
    public static final String HIBERNATE_ENTITY_PACKAGES = "be.vdab.vrijstellingenbeleid.domain";
