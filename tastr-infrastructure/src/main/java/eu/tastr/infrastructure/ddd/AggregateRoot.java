...
import eu.tastr.infrastructure.messaging.CommandHandler;
import eu.tastr.infrastructure.messaging.Event;
...
@MappedSuperclass
public abstract class AggregateRoot<ID extends eu.tastr.infrastructure.ddd.Id> extends BaseEntity<ID> {
