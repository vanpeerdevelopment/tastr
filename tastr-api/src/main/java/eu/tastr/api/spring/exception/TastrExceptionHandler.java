package eu.tastr.api.spring.exception;

import eu.tastr.infrastructure.exception.TastrEntityBestaatNietException;
import eu.tastr.infrastructure.exception.TastrException;
...
import static eu.tastr.api.spring.exception.Error.error;
import static eu.tastr.infrastructure.exception.TastrException.tastrException;
...
public class TastrExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public Error exceptionHandler(IllegalArgumentException exception, HttpServletRequest request) {
        TastrException tastrException = tastrException(exception);
        logError(tastrException, request);
        return Error.error(tastrException);
    }
